...
const projects = [
  ...
  {
    title: "Nickly",
    subtitle: "URL Shortener & Text Snippet Platform",
    description:
      "Full-featured URL shortener and text snippet web app built with Node.js, Express.js, MongoDB, and EJS. Supports custom short IDs, public/private sharing, analytics tracking, user dashboards, and a full admin panel.",
    tech: ["Node.js", "Express.js", "MongoDB", "EJS", "Chart.js", "JWT"],
